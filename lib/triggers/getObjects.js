...
async function processTrigger(msg, cfg, snapshot = {}) {
  console.log('processTrigger called with params:', msg, cfg, snapshot);
  try {
  /*
  ...
  */
    ...
    if (objects.length > 0) {
      objects.forEach((elem) => {
        ...
        */
        const formatElement = { data: elem, metadata: {} };
        console.log('transforming data', elem, cfg);
      ...
      console.log('emitting snapshot', snapshot);
